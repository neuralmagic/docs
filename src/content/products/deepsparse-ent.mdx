...
githubURL: "https://github.com/neuralmagic/docs/blob/main/src/content/products/deepsparse-enterprise.mdx"
index: 2000
---
...
1. [**The Community Edition**](https://docs.neuralmagic.com/products/deepsparse) is open-source and free for evaluation, research, and non-production use with our [Engine Community License](https://neuralmagic.com/legal/engine-license-agreement/).
2. [**The Enterprise Edition**](#installation) requires a Trial License or [can be fully licensed](https://neuralmagic.com/legal/master-software-license-and-service-agreement/) for production, commercial applications.
