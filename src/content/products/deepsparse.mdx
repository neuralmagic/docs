...
githubURL: "https://github.com/neuralmagic/docs/blob/main/src/content/products/deepsparse.mdx"
index: 1000
---
...
## Installation
See the [DeepSparse Installation Page](/get-started/install/deepsparse) for installation instructions.
