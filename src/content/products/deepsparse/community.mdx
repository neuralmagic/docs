...
- 🔌 [DeepSparse Server](/user-guides/deploying-deepsparse/deepsparse-server)
...
Review [CPU Hardware Support for Various Architectures](/user-guides/deepsparse-engine/hardware-support) to understand system requirements.
