...
DeepSparse offers up to three types of inferences based on your use case. Read [more about inference types](https://github.com/neuralmagic/deepsparse/blob/main/docs/source/scheduler.md).
