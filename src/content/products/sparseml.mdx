...
SparseML provides two avenues to accomplish this goal: 
...
For example, the following command kicks of **Sparse Transfer Learning** from pre-sparsified YOLOv5 onto the VOC dataset using the pre-made recipes in the SparseZoo:
...
For example, the following command kicks of **Sparsification of a dense YOLOv5 model from Scratch** using the pre-made recipes in the SparseZoo:
