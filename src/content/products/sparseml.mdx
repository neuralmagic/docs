...
<p>
    <a href="https://github.com/neuralmagic/sparseml/blob/main/integrations/torchvision">
        <img src="https://docs.neuralmagic.com/docs/source/highlights/sparseml/pytorch-torchvision.png" width="136px" />
    </a>
    <a href="https://github.com/neuralmagic/sparseml/blob/main/integrations/ultralytics-yolov5">
        <img src="https://docs.neuralmagic.com/docs/source/highlights/sparseml/ultralytics-yolov5.png" width="136px" />
    </a>
    <a href="https://github.com/neuralmagic/sparseml/blob/main/integrations/huggingface-transformers">
...
Currently supported ML Frameworks are the following: `torch>=1.1.0,<=1.12.1`, excluding `1.10` and `1.11`.
...
- Check out the [PyTorch integration docs](https://github.com/neuralmagic/sparseml/blob/main/integrations/torchvision) for full usage examples of the Python API.
- Check out the [Hugging Face integration docs](https://github.com/neuralmagic/sparseml/blob/main/integrations/huggingface-transformers) for details of using SparseML with the Hugging Face `Trainer`.
...
- Check out the [YOLOv5 CLI example](https://github.com/neuralmagic/sparseml/blob/main/integrations/ultralytics-yolov5/tutorials/sparse-transfer-learning.md) for more details on the YOLOv5 training pipeline
- Check out the [Hugging Face CLI example](https://github.com/neuralmagic/sparseml/blob/main/integrations/huggingface-transformers/tutorials/sparse-transfer-learning-bert.md) for more details on the available NLP training pipelines
- Check out the [Torchvision CLI example](https://github.com/neuralmagic/sparseml/blob/main/integrations/torchvision/tutorials/sparse-transfer-learning.md) for more details on the image classification training pipelines
...
- [Sparsification Recipes](/user-guides/recipes)
- [Exporting to ONNX](/user-guides/sparsification)
