...
- **Sparsifying from Scratch**&mdash;Apply state-of-the-art [sparsification](/user-guide/sparsification) algorithms such as pruning and quantization to any neural network. This gives you the flexibility to prune any neural network for any use case, but requires more training epochs and hand-tuning hyperparameters.
