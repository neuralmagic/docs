...
This page will walk through an example of deploying an object detection model with DeepSparse Server.

The DeepSparse Server is a sever wrapper around `Pipelines`, including the object detection pipeline. As such, 
