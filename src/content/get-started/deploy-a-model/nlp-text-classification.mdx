...
With all of this built on top of DeepSparse's Engine, the simplicity of servable pipelines is combined with GPU-class performance on CPUs for sparse models.
