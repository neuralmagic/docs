...
metaDescription: "Installation instructions for DeepSparse Community enabling performant neural network deployments"
index: 1000
---

# DeepSparse Community Installation

[DeepSparse Community](/products/deepsparse) enables GPU-class performance on CPUs, leveraging sparsity within models to reduce FLOPs and the unique cache hierarchy on CPUs to reduce memory movement.
