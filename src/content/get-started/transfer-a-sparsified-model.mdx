...
Once trained, deploy your model with DeepSparse for GPU-level performance on CPUs.
...
<LinkCards>
  <LinkCard href="./nlp-text-classification" heading="NLP Text Classification">
    Utilize Hugging Face Transformers to transfer an NLP model to a text classification use case.
  </LinkCard>

  <LinkCard href="./cv-object-detection" heading="CV Object Detection">
    Utilize Ultralytics YOLOv5 to transfer an object detection model to a new dataset.
  </LinkCard>
</LinkCards>
