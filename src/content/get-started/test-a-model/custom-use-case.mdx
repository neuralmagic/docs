---
title: "Custom"
metaTitle: "Test a Custom Use Case"
metaDescription: "Test a Custom Use Case and Model with the DeepSparse Engine to deploy for faster and cheaper inference on CPUs"
githubURL: "https://github.com/neuralmagic/docs/blob/main/src/content/get-started/test-a-model/custom.mdx"
index: 3000
---
...
Additionally, a CustomTaskPipeline class is available through the DeepSparse Python API, enabling easy inclusion of pre and post-processing functions.

## Model Setup

For custom model deployment, ensure your model is exported to an ONNX format.
...
With the model setup, it can then be passed into a DeepSparse CustomTaskPipeline utilizing the model_path argument alongside optional pre and post-processing functions.
