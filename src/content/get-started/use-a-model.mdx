...
<LinkCards>
  <LinkCard href="./nlp-text-classification" heading="NLP Text Classification">
    Utilize Hugging Face Transformers pipelines and benchmarking for an NLP text classification use case.
  </LinkCard>

  <LinkCard href="./cv-object-detection" heading="CV Object Detection">
    Utilize Ultralytics YOLOv5 pipelines and benchmarking for a CV object detection use case.
  </LinkCard>

  <LinkCard href="./custom-use-case" heading="Custom Use Case">
    Utilize DeepSparse to create a pipeline for a custom model.
  </LinkCard>
</LinkCards>
