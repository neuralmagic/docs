...
This example requires [SparseML Torchvision Install](/get-started/install/sparseml) with the [yolov5] extra dependency.
...
After the command completes, the trained model will reamin sparse, achieve a mAP@0&#46;5 of around 0.80 on VOC, and will be stored in the local `models/sparsified` directory.
