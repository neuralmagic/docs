...
1. Fine-tune a dense teacher model (BERT) onto a new dataset (SST-2)
...
The following script fine-tunes the dense teacher onto the SST-2 dataset for sentiment analysis.
...
The following script then transfers the sparsified DistilBERT onto the SST-2 dataset for sentiment analysis with the help of the teacher from above.
