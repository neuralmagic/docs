...
<LinkCards>
  <LinkCard href="./deepsparse" heading="DeepSparse Community">
    Install the DeepSparse Community for performant inference on CPUs.
  </LinkCard>

  <LinkCard href="./deepsparse-ent" heading="DeepSparse Enterprise">
    Install the DeepSparse Enterprise for performant inference on CPUs in production deployments.
  </LinkCard>
