...
**BERT 3-layer FP32 Sparse Throughput**<br>There is no need to add a scenario argument since async is the default option:
...
**BERT 3-layer FP32 Sparse Latency**<br>To select a synchronous inference scenario, add -s sync:
