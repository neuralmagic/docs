---
title: "Deploying With DeepSparse Server"
metaTitle: "Deploying With DeepSparse Server"
metaDescription: "Instructions for deploying with DeepSparse Server for faster and cheaper model deployments behind an HTTP API"
index: 1000
---
...
This use case requires the installation of [DeepSparse Server](/installation-guides/product-suite-installation/deepsparse).
