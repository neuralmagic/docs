...
metaTitle: "Deploying With DeepSparse on Amazon SageMaker"
metaDescription: "Instructions for deploying with DeepSparse on Amazon SageMaker for faster and cheaper model deployments behind an HTTP API"
index: 2000
---
...
The `EndpointConfig` settings may be adjusted to set instance scaling rules based
on deployment needs.
