...
Neural Magic's Platform provides models and tools needed to create sparse models and a CPU-based inference engine that runs sparse models at GPU speeds.
