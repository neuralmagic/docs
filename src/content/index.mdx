...
Neural Magic's Deep Sparse Platform provides the models and tools needed create sparse models and a CPU-based inference engine that runs sparse models at GPU speeds.
