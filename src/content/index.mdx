...
Using the Deep Sparse Platform, you are free to deploy your neural networks anywhere you have a CPU from edge to cloud. [Does "from edge to cloud" modify CPU or neural networks? If neural networks, I would rewrite as:  ... your neural networks--from edge to cloud--anywhere you have a CPU.]
