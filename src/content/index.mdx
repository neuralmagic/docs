...
Because DeepSparse reaches GPU-class performance, users no longer need to tether deployments to special
accelerators to reach the performance needed for production. Free from specialized accelerators, 
