---
title: "Hardware and Reqirements"
metaTitle: "Hardware and Requirements"
metaDescription: "Hardware and general requirements for Neural Magic solutions"
index: 3000
skipToChild: True
---

# Hardware and General Requirements
...
Neural Magic products—DeepSparse (Community and Enterprise), SparseML, and SparseZoo—are installed with PyPI (pip 20.3+ is required). It is recommended to install in a virtual environment to encapsulate your local environment.
