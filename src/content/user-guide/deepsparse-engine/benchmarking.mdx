---
title: "Benchmarking"
metaTitle: "Benchmarking ONNX models in DeepSparse"
metaDescription: "Benchmarking ONNX models in the DeepSparse Engine"
githubURL: "https://github.com/neuralmagic/docs/blob/main/src/content/user-guide/deepsparse-engine/benchmarking.mdx"
index: 3000
---

# Benchmarking ONNX models in DeepSparse

This page explains how to use the DeepSparse Benchmarking utilities out of the box.
