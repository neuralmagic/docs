...
- **System Logging** is *enabled* by default. If no `logger` is specified, a Python Logger is used.
...
- Logs the mean pixel of the first channel of the first item to Prometheus/StdOut
