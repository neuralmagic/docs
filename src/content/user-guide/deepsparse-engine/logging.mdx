...
`loggers` configures the loggers. It is a dictionary of the form `{logger_name: {arg_1: arg_value}}`. 
...
[Checkout our example of running DeepSparse Logging with Prometheus/Grafana](https://github.com/neuralmagic/deepsparse/tree/rs/logging-example/examples/logging-prometheus).
...
## Tutorials
Checkout out our [Example monitoring DeepSparse with Prometheus / Grafana](https://github.com/neuralmagic/deepsparse/tree/main/examples/logging-prometheus)
