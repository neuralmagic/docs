...
This example requires the [DeepSparse Server Install](/get-started/install/deepsparse).
...
wget https://raw.githubusercontent.com/neuralmagic/docs/rs/logging-feature/src/files-for-examples/logging/goldfish.jpeg
