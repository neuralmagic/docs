...
githubURL: "https://github.com/neuralmagic/docs/blob/main/src/content/user-guide/deepsparse-engine/scheduler.mdx"
index: 2000
---
...
Single-stream scheduling; requests execute serially by default_
...
Multi-stream scheduling; requests execute in parallel and may utilize hardware resources better_
