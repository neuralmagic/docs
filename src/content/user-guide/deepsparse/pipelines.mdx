...
title: "Pipelines"
metaTitle: "Pipelines"
metaDescription: "Using DeepSparse Pipelines"
index: 1000
---
...
pre- and post-processing, enabling you to pass raw data to the Pipeline and recieve the predictions.

The following sentiment analysis example demonstrates how to use the Pipeline API:
...
DeepSparse Pipelines support many common CV and NLP use cases out of the box, specified by 
the `task` argument in `Pipeline.create()`.

Checkout the links below for detailed examples of each use case.
...
Download an ONNX file for the demo. We will use a 95% pruned-quantized ResNet-50.
```
...
Download an image for the demo:
```
