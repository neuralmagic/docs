...
<p align="center">
    <img width="90%" src="https://raw.githubusercontent.com/neuralmagic/docs/arm-alpha/src/images/arm-benchmarks.png"/>
</p>
...
Checkout the [Use Cases](/use-cases/natural-language-processing/question-answering) for more details 
on how to setup an inference pipeline or REST endpoint with DeepSparse.
