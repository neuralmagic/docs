...
The following statistics were generated using `deepsparse-nightly==xxx` on an `M6g.16xlarge` instance (64 cores).

<p align="center">
    <img width="100%" src="https://raw.githubusercontent.com/neuralmagic/docs/arm-alpha/src/images/arm-alpha-throughput-compare.png"/>
</p>
