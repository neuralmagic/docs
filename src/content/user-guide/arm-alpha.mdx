...
In our recent 1.4 product release, we launched alpha support for DeepSparse on AWS Graviton and Ampere. We are working toward a general release across ARM servers, embedded (like Raspberry Pi), and mobile (like Android) platforms in the first half of 2023.
