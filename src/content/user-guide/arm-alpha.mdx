...
Neural Magic has released an Alpha version of DeepSparse for ARM platforms in December 2022's 1.3 release.

This page explains how to trial the ARM Alpha.

[Sign-up for early access to the general release of DeepSparse on ARM](/link/to/form).
...
The following AWS Instances are certfied for use with the DeepSparse ARM Alpha:
- XXX
