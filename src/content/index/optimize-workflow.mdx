...
- [Check out a sparse transfer learning example](/get-started/transfer-a-sparsified-model)
...
#### Additional Resources
- [Check out a sparsifying from scatch example](/get-started/sparsify-a-model/custom-integrations)
- [Check out our guide on creating a hyperparameter recipe](/user-guides/recipes/creating)
