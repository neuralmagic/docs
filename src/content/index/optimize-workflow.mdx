...
The DeepSparse Platform enables users to optimize models for inference.

### Motivation 

There are multiple factors to consider when creating a deep learning model. In training, accuracy on the test-set 
is the primary metric that is always the focus. In deployment, the performance of the model (latency/throughput) becomes 
...
Importantly, they use *training-aware* pruning and quantization algorithms. Training-aware techniques 
