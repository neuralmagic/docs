...
The Neural Magic Platform enables users to optimize models for inference on CPUs.
...
For example, below is the sparsity profile of both an example CNN and Transformer in SparseZoo:
