...
metaDescription: "Overview of the capabilities for optimizing a model for inference with the Neural Magic Platform.
index: 1000
---

# Optimize a Model for Inference

The Neural Magic Platform enables users to optimize models for inference.
...
|Throughput Improvment vs Dense |6.0x       |8.8x        |
