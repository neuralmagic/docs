...
The Neural Magic Platform enables you to (1) Optimize a Model for Inference and (2) Deploy a Model on CPUs
with GPU-class performance.
...
By leveraging sparsification techniques like pruning and quantization, users reach GPU-class
performance when deploying CPUs with a sparsity-aware inference runtime like DeepSparse.
...
onto custom data while maintaining sparsity
...
- Get Started With [Sparse Transfer Learning](/get-started/transfer-a-model)
...
meaning you can pass raw strings and recieve answers and a DeepSparse Pipeline in the Object Detection domain handles 
...
- Refer to [Use Cases](/use-cases) for Details on Usage of Each Supported Use Case
...
Multi-Stream Inference, and Dynamic Batch. Checkout the documentation on the [Pipeline Class](/user-guide/pipelines)
...
Checkout the documentation on the [Server Class](/user-guide/server) or the ad-hoc user guides:
- [Multi-Stream Scheduling Overview](/user-guide/deepsparse-engine/scheduler)
- Example Using Multi-Stream in Pipelines [Docs Coming Soon]
- Data Logging in Pipelines [Docs Coming Soon]
- Dynamic Batch [Docs Coming Soon]
