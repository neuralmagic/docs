...
title: "FAQs"
metaTitle: "FAQs"
metaDescription: "FAQs for Neural Magic.
index: 2000
---
...
Ridgeline Partners, Neural Magic is the creator and maintainer of the Deep Sparse Platform. It has several components, including
[DeepSparse,](/products/deepsparse) a CPU runtime that runs sparse models at GPU speeds. To enable companies the ability to use
