...
metaTitle: "Deploy Image Classification Models on CPUs with DeepSparse"
metaDescription: "Deploy Image Classification Models on CPUs with DeepSparse"
index: 2000
---
...
- `Pipeline` is the default API. Similiar in concept to Hugging Face Pipelines, it wraps `Engine` with pre-preprocessing
