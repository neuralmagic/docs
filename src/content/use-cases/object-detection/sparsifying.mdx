...
- `--recipe` encodes the hyperparameters of the pruning process. It can be a SparseZoo stub or a local YAML file. See [Creating Sparsification Recipes](/user-guide/recipes/creating) for more information.
