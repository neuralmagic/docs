...
SparseML's recipe-driven approach is integrated with the [ultralytics/yolov5](https://github.com/ultralytics/yolov5) repository to enable performant object detection use cases.
