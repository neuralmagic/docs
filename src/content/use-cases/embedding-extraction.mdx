...
```
wget https://raw.githubusercontent.com/neuralmagic/docs/rs/embedding-extraction-feature/src/files-for-examples/user-cases/embedding-extraction/goldfish.jpg
```
...
```bash
wget https://raw.githubusercontent.com/neuralmagic/docs/rs/embedding-extraction-feature/src/files-for-examples/user-cases/embedding-extraction/config.yaml
