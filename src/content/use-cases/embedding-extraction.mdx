...
With Hugging Face Transformers, you can use `task=transformer_embedding_extraction` for some extra utilities.
...
The second utility is automatic embedding dimenonality reduction. You `extraction_strategy` to perform a reduction on the sequence dimension rather 
