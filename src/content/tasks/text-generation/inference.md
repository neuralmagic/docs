...
Under the hood, however, DeepSparse Pipelines use the DeepSparse Runtime developed by Neural Magic's HPC engineers, to accelerate inference. The DeepSparse Runtime is especially optimized to accelerate performance by taking advantage of sparsity and quantization.
