...
✅ Learn more about:
- [Custom integrations](https://docs.neuralmagic.com/get-started/sparsify-a-model/custom-integrations) for more details on the Python API.
- [Creating recipes](https://docs.neuralmagic.com/user-guides/recipes).
