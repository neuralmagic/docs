...
- features
- benchmarking
description: Benchmarking ONNX models with DeepSparse
...
Use of the DeepSparse Benchmarking utilities requires installation of the [DeepSparse](/get-started/install/deepsparse).
