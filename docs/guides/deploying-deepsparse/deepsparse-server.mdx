...
keywords:
- to-do
description: Wrap pipelines with a REST API using FastAPI. Send raw data over HTTP and receive the prediction. Benefit from faster and cost-effective model deployments.
